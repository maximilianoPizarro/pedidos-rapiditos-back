...
import com.pedidosrapiditos.app.repository.ProductoCategoriaRepository;
import com.pedidosrapiditos.app.service.ProductoCategoriaService;
...
/**
 * REST controller for managing {@link com.pedidosrapiditos.app.domain.ProductoCategoria}.
 */
@RestController
@RequestMapping("/api")
public class ProductoCategoriaResource {
    ...
    private static final String ENTITY_NAME = "pedidosrapiditosProductoCategoria";
