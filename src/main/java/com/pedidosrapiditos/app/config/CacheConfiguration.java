package com.pedidosrapiditos.app.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.pedidosrapiditos.app.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.pedidosrapiditos.app.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, com.pedidosrapiditos.app.domain.User.class.getName());
            createCache(cm, com.pedidosrapiditos.app.domain.Authority.class.getName());
            createCache(cm, com.pedidosrapiditos.app.domain.User.class.getName() + ".authorities");
