  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="pedidosrapiditosApp.producto.home.createOrEditLabel"
          data-cy="ProductoCreateUpdateHeading"
          v-text="$t('pedidosrapiditosApp.producto.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('pedidosrapiditosApp.producto.nombre')" for="producto-nombre">Nombre</label>
            <input
              type="text"
              class="form-control"
              name="nombre"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('pedidosrapiditosApp.producto.descripcion')" for="producto-descripcion"
              >Descripcion</label
            >
            <input
              type="text"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('pedidosrapiditosApp.producto.precio')" for="producto-precio">Precio</label>
            <input
              type="number"
              class="form-control"
              name="precio"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('pedidosrapiditosApp.producto.medida')" for="producto-medida">Medida</label>
            <select
              class="form-control"
              name="medida"
              ...
              required
            >
              <option value="S" v-bind:label="$t('pedidosrapiditosApp.Medida.S')">S</option>
              <option value="M" v-bind:label="$t('pedidosrapiditosApp.Medida.M')">M</option>
              <option value="L" v-bind:label="$t('pedidosrapiditosApp.Medida.L')">L</option>
              <option value="XL" v-bind:label="$t('pedidosrapiditosApp.Medida.XL')">XL</option>
              <option value="XXL" v-bind:label="$t('pedidosrapiditosApp.Medida.XXL')">XXL</option>
            </select>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('pedidosrapiditosApp.producto.image')" for="producto-image">Image</label>
            <div>
              <img
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('pedidosrapiditosApp.producto.activo')" for="producto-activo">Activo</label>
            <input
              type="checkbox"
              class="form-check"
              name="activo"
              id="producto-activo"
              data-cy="activo"
              :class="{ valid: !$v.producto.activo.$invalid, invalid: $v.producto.activo.$invalid }"
              v-model="$v.producto.activo.$model"
            />
          </div>
          <div class="form-group">
            <label class="form-control-label" v-text="$t('pedidosrapiditosApp.producto.restaurante')" for="producto-restaurante"
              >Restaurante</label
            >
            <select
              class="form-control"
              id="producto-restaurante"
              data-cy="restaurante"
              name="restaurante"
              v-model="producto.restaurante"
              required
            >
              <option v-if="!producto.restaurante" v-bind:value="null" selected></option>
              <option
                v-bind:value="
                  producto.restaurante && restauranteOption.id === producto.restaurante.id ? producto.restaurante : restauranteOption
                "
          ...
          <div v-if="$v.producto.restaurante.$anyDirty && $v.producto.restaurante.$invalid">
            <small class="form-text text-danger" v-if="!$v.producto.restaurante.required" v-text="$t('entity.validation.required')">
              This field is required.
            </small>
          </div>
          <div class="form-group">
            <label class="form-control-label" v-text="$t('pedidosrapiditosApp.producto.productoCategoria')" for="producto-productoCategoria"
