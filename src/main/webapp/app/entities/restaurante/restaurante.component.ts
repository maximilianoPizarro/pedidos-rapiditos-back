...
export default class Restaurante extends mixins(JhiDataUtils) {
        ...
        res => {
          if (res.data && res.data.length > 0) {
            for (let i = 0; i < res.data.length; i++) {
              this.restaurantes.push(res.data[i]);
            }
  ...
  public removeRestaurante(): void {
    this.restauranteService()
      ...
      .then(() => {
        const message = this.$t('pedidosrapiditosApp.restaurante.deleted', { param: this.removeId });
